    ...
    d.AmDraw = d.Class({
     ...
     addDefs: function(a) {
      if (d.hasSVG) {
       ...
       a && (a.addCodeCredits && b.appendChild(document.createTextNode(" " + a.version)), a.accessibleDescription && (b.innerHTML = "", b.appendChild(document.createTextNode(a.accessibleDescription))), c.appendChild(b), a.defs && (b = this.createSvgElement("defs"), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b))
      }
     }
    })
   })();
